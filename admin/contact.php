...
if(input::exists()){
    if(token::check(input::get('token'))){
        ...
        if($validation->passed()){
            $update = db::getInstance()->update('pages','2',array('content'=>input::get('content')));
            if($update){
                session::flash('contact','The Contact us page has been updated');
                ...
                <div class="row">
                    <div class="col-lg-12">
                        <div class="alert alert-success alert-dismissable">
                            ...
                            <?php
                            echo '<p><i class="fa fa-check-square"></i> '.session::flash('contact').'</p>';
                            ?>
                        </div>
                    </div>
                </div>
